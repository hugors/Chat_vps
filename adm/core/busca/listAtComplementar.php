                        ...
                        foreach($resultado as $item)
                             {
                                 ...
                                 $linkexcluir = "../excluirAtvComp.php?id=$id";
                                 $linkEditar = "EditLiberaDisciplina.php?id=$id";
                        ?>
                          <tr>
                            ...
                            <td><a href="<?= $linkexcluir ?>"><center><font color="#db1709" ><i class="fas fa-times-circle" ></i> </font> </a></center></td>
                           <!-- <td><a href="<?= $linkEditar ?>"><center><font color="#1765e3" ><i class="fas fa-pencil-alt" ></i> </font> </a></center></td> -->
                          </tr>
                          <?php
                             }
                          ?>
