...
$queryDisciplina = $conexao->prepare("  
SELECT DISTINCT 
	...
	SDISCIPLINA.CH						AS CH_DISCIPLINA,
	SDISCIPLINA.NUMCREDITOS				AS CREDITOS_DISC,
    SALUNO.RA                           AS RA,
    SDISCIPLINA.NOME                    AS DISCIPLINA,
    PPESSOA.NOME						AS NOMEALUNO,
	SHABILITACAOALUNO.CODCAMPUS			AS CODCAMPUS
FROM 
    SALUNO
