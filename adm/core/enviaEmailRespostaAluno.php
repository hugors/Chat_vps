...
$mail->setFrom('suporteti@castelobranco.br', 'Fechamento Protocolo - UCB');
$mail->addReplyTo('suporteti@castelobranco.br', 'UCB');
$mail->addAddress($emailDestino, '');
$mail->Subject = 'Fechamento de Protocolo - UCB';
...
<body>
    <div class='container'>
        <div class='header'>
            <p class='maiusculo'>protocolo :$numProtocolo</p>
        </div>
        <div id='conteudo'>
            <p class='titulo'>Prezado(a) Aluno(a),</p>
            <p class='subtitulo'> Segue fechamento do seu protocolo com data de fechamento $dataFechamento </p>
            <p class='subtitulo'> Descrição de fechamento : $descicaoCoordenador</p>
        </div>
    </div>
</body>
